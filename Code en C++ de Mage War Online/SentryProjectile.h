...
class SentryProjectile : public ProjectileBase
{
private:
	...
	float range_projectile = 1500;
	float speed_projectile = 250;
	float timer_animation = 0.01;
	sf::Vector2f position_origin;
	sf::Vector2f size_projectile{ 30,14 };
...
public:
	...
	void Init(sf::Vector2f &position_initial, float damage_received, float direction_projectile_received, float speed_received, int id_caster);
