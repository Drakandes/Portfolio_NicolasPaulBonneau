...
class Ninja : public PetBase
{
private:
	int language = ListObjectsSingleton::instance()->GetCurrentLanguage();
	enum PetSKill{ NoSkill,Shuriken_E,Katana_E,Dagger_E,Frenzy,Empower,Cruel,SelfEsteem,HugeShuriken,PassiveDmg,PassiveSpeed,PassiveAts,PassiveLifesteal,PassiveCooldown };
	...
	float range_from_player = 325;
	float speed_initial = 225;
...
public:
	...
	virtual int GetTypePet() { return Ninja_E; }
