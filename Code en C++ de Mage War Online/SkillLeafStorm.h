...
class SkillLeafStorm : public SkillBase
{
private:
	int language;
	sf::Texture texture_icone;
	const static int number_string_skill_information = 3;
	...
	float number_of_projectile = 3;
	float range_projectile = 50;
	float damage_percent_projectile;
...
public:
	SkillLeafStorm(int current_language);
	~SkillLeafStorm();
