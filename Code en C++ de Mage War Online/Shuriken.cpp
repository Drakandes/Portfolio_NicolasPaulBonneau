...
Shuriken::Shuriken()
{
	texture_projectile.loadFromFile("Shuriken.png");
	shadow_texture.loadFromFile("ShurikenShadow.png");
}
...
void Shuriken::Init(sf::Vector2f &position_initial, float damage_received, float direction_projectile_received, int id_caster, float speed, bool can_affect_player,bool can_affect_monster, float range_projectile)
{
	id_parent = id_caster;
	...
	size_projectile = sf::Vector2f(16, 16);
