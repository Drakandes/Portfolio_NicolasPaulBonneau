...
class A_RobeOfTheMasterElite : public A_ArmorBase
{
public:
	int language;
	...
	sf::String armor_bonus_string = "+30% Health & Armor";
	...
	A_RobeOfTheMasterElite(int current_language);
	~A_RobeOfTheMasterElite();
};
