...
Dagger::Dagger()
{
	texture_projectile.loadFromFile("Dagger.png");
	shadow_texture.loadFromFile("DaggerShadow.png");
}
...
void Dagger::Init(sf::Vector2f &position_initial, float damage_received, float direction_projectile_received, int id_caster, float speed, bool can_affect_player, bool can_affect_monster, float range_projectile)
{
	id_parent = id_caster;
	...
	size_projectile = sf::Vector2f(7, 14);
