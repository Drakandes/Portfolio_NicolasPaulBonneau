...
MagicLeaf::MagicLeaf()
{
	texture_projectile.loadFromFile("MagicLeaf.png");
	shadow_texture.loadFromFile("MagicLeafShadow.png");
}
...
void MagicLeaf::Init(sf::Vector2f &position_initial, float damage_received, float direction_projectile_received, int id_caster, float speed, bool can_affect_player, bool can_affect_monster, float range_projectile)
{
	id_parent = id_caster;
	...
	size_projectile = sf::Vector2f(22, 7);
...
void MagicLeaf::DealWithCollision(std::shared_ptr<CollisionalObject> object_collided)
{
